...
def get_conversational_chain():
    ...
    provided context just say, "answer is not available in the context", don't provide the wrong answer. If the question is numeric the give the correct solution\n\n
    Context:\n {context}?\n
    Question: \n{question}\n
